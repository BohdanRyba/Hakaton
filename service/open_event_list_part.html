...
<head>
  <meta charset="utf-8">
  <meta name="author" content="Andriy Slotvinskiy">
  ...
  <!-- daterange picker -->
  <link rel="stylesheet" href="../views/main/plugins/daterangepicker/daterangepicker.css">
  <!-- bootstrap datepicker -->
  <link rel="stylesheet" href="../views/main/plugins/datepicker/datepicker3.css">
  <!-- iCheck for checkboxes and radio inputs -->
  <link rel="stylesheet" href="../views/main/plugins/iCheck/all.css">
  <!-- Bootstrap Color Picker -->
  <link rel="stylesheet" href="../views/main/plugins/colorpicker/bootstrap-colorpicker.min.css">
  <!-- Bootstrap time Picker -->
  <link rel="stylesheet" href="../views/main/plugins/timepicker/bootstrap-timepicker.min.css">
  <!-- Select2 -->
  <link rel="stylesheet" href="../views/main/plugins/select2/select2.min.css">
  <!-- Theme style -->
  <link rel="stylesheet" href="../views/main/css/AdminLTE.min.css">
  <!-- AdminLTE Skins. Choose a skin from the css/skins
  folder instead of downloading all of them to reduce the load. -->
  <link rel="stylesheet" href="../views/main/css/skins/_all-skins.min.css">
  <link rel="stylesheet" type="text/css" href="../views/main/css/skins/skin-blue.min.css">
  <link rel="stylesheet" type="text/css" href="../views/main/css/style.css">
  <link rel="stylesheet" type="text/css" href="../views/main/fixis.css">
...
<body class="hold-transition skin-blue sidebar-mini">
        ...
        <div class="content_box col-md-4">
          <div class="box box-info">
            <div class="box-header with-border">
              <h2 class="box-title">Список участников на сщбытие бла бла бла фекшин, органиации ХОАСБТ</h2>
            </div>
            <div class="box-body">
                    ...
                    <table id="example1" class="table table-bordered table-striped dataTable" role="grid" aria-describedby="example1_info">
                      ...
                      <thead>
                        <tr role="row">
                          ...
                          <th class="sorting_asc" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" style="width: 181px;" aria-sort="ascending" aria-label="Rendering engine: activate to sort column descending">Сума:</th>
                          ...
                          <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" style="width: 198px;" aria-label="Platform(s): activate to sort column ascending">Команда</th>
                          <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" style="width: 155px;" aria-label="Engine version: activate to sort column ascending">Город</th>
                          <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" style="width: 110px;" aria-label="CSS grade: activate to sort column ascending">Тренер</th>
                        </tr>
                      </thead>
                      ...
                      <tfoot>
                        <tr>
                          ...
                          <th rowspan="1" colspan="1">Команда</th>
                          <th rowspan="1" colspan="1">Город</th>
                          <th rowspan="1" colspan="1">Тренер</th>
                        </tr>
                      </tfoot>
                    </table>
                  </div>
 ...
 <!-- /.control-sidebar -->
    ...
    <script src="../views/main/plugins/daterangepicker/daterangepicker.js"></script>
    <!-- bootstrap datepicker -->
    <script src="../views/main/plugins/datepicker/bootstrap-datepicker.js"></script>
    <!-- bootstrap color picker -->
    <script src="../views/main/plugins/colorpicker/bootstrap-colorpicker.min.js"></script>
    <!-- bootstrap time picker -->
    ...
    <!-- AdminLTE App -->
    <script src="../views/main/js/app.js"></script>
    <!-- AdminLTE for demo purposes -->
    <script src="../views/main/js/demo.js"></script>
