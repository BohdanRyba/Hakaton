...
--
-- Хост: 127.0.0.1
-- Время создания: Май 13 2017 г., 00:35
...
(2, 'LivLegend', '../../../views/main/img/club_img/gena.jpg', 'Ukraine', 'Khmelnytski', 'Геннадий', 48692600399, 'gena@i.ua', 'e0a7bf6b3b6eb370828d29888d4805bc', 4, 1, 6, 'Дима&Саша&Petro&Sergey&Lesya&Kira');
...
(24, 'qqqqqqqq', 'eeeeeeeeeeeeeeeeee', 'rrrrrrrrrrrrrrrrrrrr', 'ttttttttttttttttt', 6, 0, 0, '22&16&19'),
(4, 'Хіп-хоп', 'Дорослі', 'Кращий виспут за думкою глядачів', 'Профі', 5, 905567, 1, ''),
(16, 'B&B', 'Дорослі', 'Краща техніка виконання', 'Початківці', 6, 234, 0, '22'),
...
(17, 'B&B', 'Діти', 'Кращий виспут за думкою глядачів', 'Профі', 6, 1235, 0, '12&43&32&11'),
