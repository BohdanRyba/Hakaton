...
CREATE TABLE `clubs` (
  ...
  `session_ttl` int(11) UNSIGNED NOT NULL DEFAULT '120',
...
(5, 'Club', 'views/main/img/club_img/IMG_8386.JPG', 'Fortuna', 'Luck', 'Griobani luckery', '(067) 321-0011', 'clubdance@i.ua', 'a25e9b5b9b704b13af47bc17630e7a78', 1, 1, 0, 'Trener&Trener one', '0000-00-00 00:00:00', 120, '0000-00-00 00:00:00');
