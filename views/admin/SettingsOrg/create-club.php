    ...
    <div class="box-body">
      <div class="form-group">
        ...
        <div class="col-sm-10">
          ...
          <input type="text" class="form-control" id="inputEmail3" name="club_name" placeholder="Название клуба">
        </div>
      </div>
      ...
      <div class="form-group">
        ...
        <div class="col-sm-10">
          <input type="text" class="form-control" name="club_country" id="inputPassword3" placeholder="Страна">
        </div>
      </div>
      <div class="form-group">
      ...
      <div class="form-group">
        ...
        <div class="col-sm-10">
          <input type="text" class="form-control" name="club_shief" id="inputPassword3" placeholder="Руководитель клуба">
        </div>
      </div>
      <div class="form-group">
        <label for="inputPassword3" class="col-sm-2 control-label">Тренер №1</label>
        <div class="col-sm-10">
          <input type="text" class="form-control" name="club_first_trener" id="inputPassword3" placeholder="Тренер №1">
        </div>
      </div>
      <div class="form-group">
        <label for="inputPassword3" class="col-sm-2 control-label">Тренер №2</label>
        <div class="col-sm-10">
          <input type="text" class="form-control" name="club_second_trener" id="inputPassword3" placeholder="Тренер №2">
        </div>
      </div>
      <div class="form-group">
        <label for="inputPassword3" class="col-sm-2 control-label">Тренер №3</label>
        <div class="col-sm-10">
          <input type="text" class="form-control" name="club_third_trener" id="inputPassword3" placeholder="Тренер №3">
        </div>
      </div>
      <div class="form-group">
        <label for="inputPassword3" class="col-sm-2 control-label">Номер телефона</label>
        <div class="col-sm-10">
          <input type="tel" class="form-control" name="club_number" id="inputPassword3" placeholder="Номер телефона">
        </div>
      </div>
      <div class="form-group">
