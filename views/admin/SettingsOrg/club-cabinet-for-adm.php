...
<head>
    ...
    <link rel="stylesheet/less" type="text/less"
          href="<?= Router::$permalink ?>views/main/css/pick_categories_for_event.less">
...
<div class="wrapper">
                ...
                <div class="box box-info">
                    ...
                    <div class="resize-remove">
                        ...
                        <div class="box-header with-border">
                            <h2 class="box-title">Кабинет клуба <span>"<?= $participant['club_name'] ?>", состоит в организации <a href="<?= Router::$permalink . 'admin/organizations/org_settings/' . $organization['id'] ?>">"<?= $organization['org_name'] ?>"</a></span></h2>
                        </div>
                        <div class="box-body">
    ...
    <script
        src="<?= Router::$permalink ?>views/main/js/pick_categories_for_event.js?<?php echo date("Y-m-d_H:i:s"); ?>"></script>
</body>
</html>
