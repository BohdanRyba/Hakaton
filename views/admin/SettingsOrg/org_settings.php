...
<head>
    ...
    <![endif]-->
    <link rel="stylesheet/less" type="text/less" href="<?=Router::$permalink?>views/main/css/add_dancing_categories.less?1">
    <script src="<?=Router::$permalink?>views/main/js/less.min.js?1" type="text/javascript"></script>
</head>
<!--
BODY TAG OPTIONS:
=================
