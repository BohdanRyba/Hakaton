                    ...
                    <div class="cont-box clear">
                        <div class="button-box clr">
                            <ul class="button-org-add clr">
                                <li class="button-list"><span>Список событий</span></li>
                        ...
                        <div class="button-box clr">
                            ...
                            <div class="search-wrapp">
                                <div class="list-search-button">
                                    <form method="GET" action="" class="line-search">
                                        <div class="input-group input-group-sm">
                                            <input class="form-control" type="text" placeholder="Поиск по категориям">
                                            <span class="input-group-btn">
                          <button type="button" class="btn-search btn btn-info btn-flat">Go!</button>
                        </span>
                                        </div>
                                    </form>
                                </div>
                                <div class="list-information col-sm-12">
                                    <ul class="list-data">
                                        <li>
                                            <div class="list-search clr">
                                                <div><img src="" alt=""></div>
                                                <div><span>Категория: бала бла блааал крю</span></div>
                                            </div>
                                        </li>
                                        <li>
                                            <div class="list-search clr">
                        ...
                        <div class="button-box clr">
                            ...
                            <div class="search-wrapp">
                                <div class="list-search-button">
                                    <form method="GET" action="" class="line-search">
                                        <div class="input-group input-group-sm">
                                            <input class="form-control" type="text" placeholder="Поиск по клубам">
                                            <span class="input-group-btn">
                          <button type="button" class="btn-search btn btn-info btn-flat">Go!</button>
                        </span>
                                        </div>
                                ...
                                <div class="list-information col-sm-12">
                                    <ul class="list-data">
                                        <li>
                                            <div class="list-search clr">
                                                <div><img src="" alt=""></div>
                                                <div><span>Клуб: бала бла блааал крю</span></div>
                                            </div>
                                        </li>
                                        <li>
                                            <div class="list-search clr">
