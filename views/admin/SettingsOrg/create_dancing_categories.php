                ...
                <div class="row">
                    <div class="col-xs-10">
                        ...
                        <div class="container box box-solid box-primary flat">
                            <!--<input type="text" name="dance-group-name-for-this-organization">-->
                            <div class="row">
                                    <div class="col-xs-12 col-sm-6">
                                        <div id="choose-dancing-group">
                                            <select name="" id="" style="width: 100%;">
                                                <option>Dance group 1</option>
                                                <option>Dance group 2</option>
                                                <option>Dance group 3</option>
                                            </select>
                                        </div>
                                    </div>
                            </div>
