...
<head>
    ...
    <link rel="stylesheet" href="<?=Router::$permalink?>views/main/fixis.css">
                    ...
                    <form class="form-horizontal" method="post" action="org_reg" enctype="multipart/form-data">
                        <div class="box-body">
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input name="org_name" type="text" class="form-control" id="inputEmail3" placeholder="Название организации">
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="inputPassword3" class="col-sm-2 control-label">Краткое название организации</label>
                                <div class="col-sm-10">
                                    <input name="org_abbreviation" type="text" class="form-control" id="inputPassword3" placeholder="Краткое название организации">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input name="org_head_fio" type="text" class="form-control" id="inputPassword3" placeholder="ФИО руководителя">
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input name="org_phone" type="tel" class="form-control" id="inputPassword3" placeholder="Номер телефона">
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="inputPassword3" class="col-sm-2 control-label">Адрес електроной почты</label>
                                <div class="col-sm-10">
                                    <input name="org_email" type="e-mail" class="form-control" id="inputPassword3" placeholder="e-mail">
                                </div>
                            </div>
                            <div class="form_in">
