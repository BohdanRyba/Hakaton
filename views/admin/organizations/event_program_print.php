...
<head>
    ...
    <link rel="stylesheet/less" type="text/less" href="<?= Router::$permalink ?>views/main/css/event_program_print.less?10">
...
<script src="<?= Router::$permalink ?>views/main/js/eventProgramPrintDragInit.js?9"></script>
</body>
</html>